        ...
        Login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(number.getText().toString().trim().equals("")) {
                    ...
                    progressDialog.show();
                    Call<BusiRegsWrapper> call = RetrofitCall.getApi().getLogin(new GlobalMethods().Base64Encode(Common.API_KEY),number,password);
                        ...
                        public void onResponse(Call<BusiRegsWrapper> call, Response<BusiRegsWrapper> response) {
                            if (response.code()==Common.RESPONSE_CODE)
                            {
                                ...
                                if(busiRegsWrapper.getStatus().equals(Common.SUCCESS))
                                {
                                    ...
                                    shareUtils.saveString(Common.USER_ID,loginDataWrapper.getData().get(0).getUser_id());
